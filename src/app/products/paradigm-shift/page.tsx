...
export const metadata = {
  ...
  description: 'Paradigm-Shift is a real-time HRMS platform for modern teams. Manage people, performance, and workflows in one place.',
};
...
export default function ParadigmShiftPage() {
  return (
    <ProductLanding
      ...
      features={[
        { title: 'People operations', description: 'Manage teams, roles, and internal movement cleanly.', icon: '•' },
        { title: 'Performance tracking', description: 'Keep progress and review loops visible in one system.', icon: '•' },
        { title: 'Operational workflows', description: 'Reduce handoff friction across the company.', icon: '•' },
      ]}
      caseStudies={[
        {
          title: 'Unified HR flow',
          description: 'Used as a central workflow layer to reduce fragmentation across people operations.',
    ...
    >
      <div style={{ display: 'grid', gap: '14px', width: '100%', fontFamily: 'var(--font-sans)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', border: '1px solid var(--border)', borderRadius: '12px', background: 'rgba(255,255,255,0.03)' }}>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--accent)', fontSize: '13px', fontWeight: 'bold' }}>
            <Workflow size={16} /> HR Operations Console
          </span>
          <span style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: 'var(--white-dimmer)' }}>8 pipeline segments active</span>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
          ...
          {/* Column 1 */}
          <div style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border)', borderRadius: '8px', padding: '10px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '9px', fontFamily: 'var(--font-mono)', color: 'var(--accent-dim)', textTransform: 'uppercase' }}>Hiring</span>
            <div style={{ padding: '8px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border)', borderRadius: '6px', fontSize: '11px' }}>
          ...
          {/* Column 2 */}
          <div style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border)', borderRadius: '8px', padding: '10px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '9px', fontFamily: 'var(--font-mono)', color: 'var(--accent-dim)', textTransform: 'uppercase' }}>Onboarding</span>
            <div style={{ padding: '8px', background: 'rgba(212,201,168,0.06)', border: '1px solid var(--accent-dim)', borderRadius: '6px', fontSize: '11px' }}>
          ...
          {/* Column 3 */}
          <div style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border)', borderRadius: '8px', padding: '10px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <span style={{ fontSize: '9px', fontFamily: 'var(--font-mono)', color: 'var(--accent-dim)', textTransform: 'uppercase' }}>Compliance</span>
            <div style={{ padding: '8px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border)', borderRadius: '6px', fontSize: '11px' }}>
